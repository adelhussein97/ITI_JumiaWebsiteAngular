...
export class PaypalComponent implements OnInit{
  ...
  private initConfig(): void {
    this.payPalConfig = {
    currency: 'USD',
    clientId: 'ATJe0kqrhhSUlEo2RIVXnEmEE9795DGJgb6FBQa5QXIAtsYMWGyR_sNG7ecfBrA2kT4C0FNYgN-bzEMt',
...
loadCart(){
if(localStorage.getItem('localCart')){
  this.getCartDetails=JSON.parse(localStorage.getItem('localCart') as any ||[]);
